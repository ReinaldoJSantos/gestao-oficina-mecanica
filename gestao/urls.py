...
urlpatterns = [
    ...
    path("os/email/<int:pk>/",
         views.enviar_orcamento_email, name="enviar_email_os"),
    ...
    path("cliente/editar/<int:pk>/",
         views.salvar_cliente, name="editar_cliente"),
    path("cliente/excluir/<int:pk>/",
    ...
    path("veiculos/editar/<int:pk>/",
         views.salvar_veiculo, name="editar_veiculo"),
    path("veiculos/excluir/<int:pk>/",
         views.excluir_veiculo, name="excluir_veiculo"),
    path(
        "login/",
